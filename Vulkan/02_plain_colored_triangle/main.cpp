...
class WindowAppWrapper {
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("Shaders/color_triang_v.spv");
        auto fragShaderCode = readFile("Shaders/color_triang_f.spv");
        ...
        // Here is where uniforms are set up
    ...
    void createUniformBuffers(){
        VkDeviceSize bufferSize = sizeof(Color_UBO);
    ...
    void updateUniformBuffer(uint32_t currentImage){
        ...
        void* data;
        vkMapMemory(device, uniformBuffersMemory[currentImage], 0, sizeof(the_color), 0, &data);
